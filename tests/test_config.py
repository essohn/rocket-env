...
@pytest.mark.parametrize("name,path,expected", [
    ...
    ("landing-basic", ("init", "y"), 250.0),
    ("landing-basic", ("init", "x_range"), [-30.0, 30.0]),
    ("landing-basic", ("init", "omega_abs_range_deg"), [6.0, 10.0]),
    ("landing-attitude", ("init", "theta_range_deg"), [-20.0, 20.0]),
    ("landing-attitude", ("init", "y"), 300.0),
    ("landing-attitude", ("init", "omega_abs_range_deg"), [6.0, 10.0]),
    ("landing-descent", ("init", "y"), 550.0),
